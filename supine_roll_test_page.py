...
class SupineRollTestPage(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        self.test_result = ttk.Combobox(result_frame, values=[
            "", "阴性", "右外水平半规管良性阵发性位置性眩晕", "左外水平半规管良性阵发性位置性眩晕",
            "右外半规管良性阵发性位置性眩晕（管石症）可能", "左外半规管良性阵发性位置性眩晕（管石症）可能",
            "右外半规管良性阵发性位置性眩晕（嵴石症）可能", "左外半规管良性阵发性位置性眩晕（嵴石症）可能",
            "右外半规管良性阵发性位置性眩晕（嵴石症转管石症）可能", "左外半规管良性阵发性位置性眩晕（嵴石症转管石症）可能",
            "右外半规管轻嵴帽可能", "左外半规管轻嵴帽可能",
            "右外半规管重嵴帽可能", "左外半规管重嵴帽可能",
            "不典型位置性眼震", "配合欠佳"
        ], width=50)
        self.test_result.configure(height=20)
